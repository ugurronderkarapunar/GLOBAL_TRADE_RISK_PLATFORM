...
TOPIC_KEYWORDS = {
    "security": [
        "security", "defense", "defence", "military", "conflict", "war", "sanction", "ceasefire", "cyber",
        "güvenlik", "savunma", "çatışma", "savaş", "yaptırım",
    ],
    "trade": [
        "trade", "tariff", "customs", "import", "export", "supply chain", "shipping", "logistics", "port",
        "ticaret", "gümrük", "ithalat", "ihracat", "tedarik", "lojistik", "liman",
    ],
}
...
def _is_relevant_news(title: str, summary: str) -> bool:
    ...
    return any(k in text for kws in TOPIC_KEYWORDS.values() for k in kws)
